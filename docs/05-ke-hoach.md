...
**Đang ở:** Hết **Day 26** (Exam Engine API: series, structure, play, Directions) ✅  
**Tiếp theo:** **Day 27** — UI Core: chọn đề + Listening (Directions skip, playlist liền mạch, Part 1–4).
...
- Ngày 27: **UI Core — chọn đề + Listening**
  — List đề (series/card); màn cấu trúc (full mặc định / chọn Part);
  — Directions: ảnh + audio intro; Next/Bắt đầu **chỉ** ở Directions (skip được);
  — Playlist Listening liền mạch; Layout Part 1–4 (1 câu / nhóm 3 câu Part 3–4)
